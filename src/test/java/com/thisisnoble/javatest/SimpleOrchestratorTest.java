...
import com.thisisnoble.javatest.implemetation.OrchestratorImpl;
...
public class SimpleOrchestratorTest {
    ...
    private Orchestrator setupOrchestrator() {
        ...
        orchestrator.register(new RiskProcessor());
        orchestrator.register(new MarginProcessor());
        orchestrator.register(new ShippingProcessor());
        return orchestrator;
    }
